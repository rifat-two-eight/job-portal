      ...
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex gap-8 items-center">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              <User className="w-8 h-8 text-gray-500 border border-gray-300 rounded-full p-1 hover:ring-2 hover:ring-[#123499] transition" />
            </button>
        ...
        <div className="md:hidden border-t border-gray-200 bg-white">
          <nav className="flex flex-col gap-4 px-4 py-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                <User className="w-8 h-8 text-gray-500 border border-gray-300 rounded-full p-1" />
